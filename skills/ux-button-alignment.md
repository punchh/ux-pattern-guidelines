...
```
https://raw.githubusercontent.com/punchh/ux-pattern-guidelines/main/layout-and-navigation/button-alignment.md
```
...
- Always cite the source: _"Per the [Button Alignment Guidelines](https://partech.gitbook.io/ux-pattern-guidelines/layout-and-navigation/button-alignment)…"_
