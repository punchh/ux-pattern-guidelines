...
Scan the directory containing this file for all `.md` files whose frontmatter includes
a `name:` field beginning with `ux-`. Each of these is a UX pattern guideline skill.
...
Any `.md` file added to this directory with a `name: ux-*` frontmatter field will be
