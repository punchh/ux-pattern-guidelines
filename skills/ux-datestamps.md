...
```
https://raw.githubusercontent.com/punchh/ux-pattern-guidelines/main/reading-information/datestamps-and-timestamps.md
```
...
## Step 3 — Identify the display context (required before generating anything)
