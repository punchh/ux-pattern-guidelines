...
```
https://partech.gitbook.io/ux-pattern-guidelines/hyperlinks-versus-link-buttons
```
...
- Always cite the source: _"Per the [Hyperlinks vs Link Buttons Guidelines](https://partech.gitbook.io/ux-pattern-guidelines/hyperlinks-versus-link-buttons)…"_
