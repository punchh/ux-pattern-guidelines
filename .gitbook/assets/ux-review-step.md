...
```
https://partech.gitbook.io/ux-pattern-guidelines/reviewing-review-step
```
...
- Always cite the source: _"Per the [Review Step Guidelines](https://partech.gitbook.io/ux-pattern-guidelines/reviewing-review-step)…"_
