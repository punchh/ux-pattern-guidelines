...
```
https://partech.gitbook.io/ux-pattern-guidelines/multi-step-forms
```
...
- Always cite the source: _"Per the [Multi-Step Forms Guidelines](https://partech.gitbook.io/ux-pattern-guidelines/multi-step-forms)…"_
