...
```
https://partech.gitbook.io/ux-pattern-guidelines/canceling
```
...
- Always cite the source: _"Per the [Canceling Guidelines](https://partech.gitbook.io/ux-pattern-guidelines/canceling)…"_
