...
```
https://partech.gitbook.io/ux-pattern-guidelines/destructive-actions-and-deleting
```
...
- Always cite the source: _"Per the [Destructive Actions Guidelines](https://partech.gitbook.io/ux-pattern-guidelines/destructive-actions-and-deleting)…"_
