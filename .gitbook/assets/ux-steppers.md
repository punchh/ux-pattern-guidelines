...
```
https://partech.gitbook.io/ux-pattern-guidelines/steppers
```
...
- Always cite the source: _"Per the [Steppers Guidelines](https://partech.gitbook.io/ux-pattern-guidelines/steppers)…"_
