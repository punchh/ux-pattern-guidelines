...
✅ warn about irreversible changes (like a [destructive action](destructive-actions-and-deleting.md), or [canceling changes to a form](canceling.md))
...
A [destructive action like deleting](destructive-actions-and-deleting.md) is good example that should invoke a confirmation prompt, and also carries its own pattern for safely [labeling its buttons](destructive-actions-and-deleting.md#anatomy-of-a-delete-confirmation-dialog).
...
<figure><img src=".gitbook/assets/image (82).png" alt=""><figcaption><p>Finally, in a <a href="multi-step-forms.md">multi-step form </a>we use our <a href="multi-step-forms.md#navigation-bar">conventional multi-step form navigational button cluster</a></p></figcaption></figure>

Filling out forms in a modal window should still follow guidelines for when a [multi-step form](multi-step-forms.md) is appropriate.&#x20;
