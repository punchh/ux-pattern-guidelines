---
description: Understanding the difference in utility and experience
---

# Hyperlinks versus link buttons

{% hint style="success" icon="sparkles" %}
[**Get the AI skill**](hyperlinks-versus-link-buttons.md#ai-skill-file) for this UX pattern guideline in a markdown (.MD) file.
{% endhint %}
