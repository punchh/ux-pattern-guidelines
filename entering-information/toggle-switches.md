---
description: How to design for boolean options in an autosave experience
---

# Toggle switches

{% hint style="success" icon="sparkles" %}
[**Get the AI skill**](toggle-switches.md#ai-skill-file) for this UX pattern guideline in a markdown (.MD) file.
{% endhint %}
