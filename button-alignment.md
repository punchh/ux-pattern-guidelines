...
We do this to prioritize single-column, straight line vertical scanning - just like the [fields are aligned](field-alignment-and-column-layout.md). This is the submit button, often labeled "Saved".
...
In [multi-step forms](multi-step-forms.md) we prioritize the convention of rightward linear progression to determine button alignment.  
...
The left-to-right linear alignment (for Back and Save buttons respectively) also matches the [stepper navigation pattern](steppers.md) present on all multi-step forms.
...
Buttons that support the submit ("Next") button - like [Save and close for drafts](saving-drafts.md) - can come just before the Next button on the bottom right.
...
<figure><img src=".gitbook/assets/image (14).png" alt=""><figcaption><p>A modal form showing the z pattern for <a href="field-alignment-and-column-layout.md">field</a> and button alignment</p></figcaption></figure>
